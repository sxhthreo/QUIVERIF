// ----------------------------------------------------------------------------
// Medical Tourism Korea contract
// Symbol      : MDK
...
contract MedicalTourismKorea is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;
  ...
  string public constant name = "Medical Tourism Korea";
