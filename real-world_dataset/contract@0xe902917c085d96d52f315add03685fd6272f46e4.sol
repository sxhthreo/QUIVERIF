...
*/
contract VDV is FreezableBurnablePausableERC20Token {
    ...
    **/
    string public constant name = "VDV TOKEN";
    string public constant symbol = "VDV";
    uint8 public constant decimals = 18;

    uint256 public constant INITIAL_SUPPLY = 151000000 * (10 ** uint256(decimals));
