...
contract MPGToken is PausableToken {
    string  public  constant name = "Mobile Phone Games Chain";
    string  public  constant symbol = "MPG";
    ...
    function MPGToken(address _admin, uint _totalTokenAmount) public
    {
