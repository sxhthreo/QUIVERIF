...
// ----------------------------------------------------------------------------
// Transportation Utility Token Smart contract
//
// Name        : Transportation Utility Token  
// Symbol      : TUT
// Total Supply: 1 Billion (1000000000)
// Decimals    : 18
// Price       : 0.20 USD per TUT
// Rate        : 1 ETH = 660 TUT
...
contract Owned {
    ...
    constructor() public {
        owner = 0x6018996D3b0Ec08600EaDE90d4C348E7ce359Cf5;
    }
...
// ----------------------------------------------------------------------------
contract Transportation_Utility_Token is ERC20Interface, Owned {
